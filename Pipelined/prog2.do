...
add wave -noupdate /testbench_prog/clk
...
add wave -noupdate /testbench_prog/dec_imm
add wave -noupdate /testbench_prog/dec_imm_br
add wave -noupdate /testbench_prog/dec_r1
add wave -noupdate /testbench_prog/dec_r2
add wave -noupdate /testbench_prog/dec_rw
add wave -noupdate /testbench_prog/new_pc
...
update
WaveRestoreZoom {2506 ps} {2722 ps}
